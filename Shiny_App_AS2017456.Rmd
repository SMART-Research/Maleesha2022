...
renderUI({
  ...
  selectInput("Variable 1", label = "Select numerical variable", choices = colnames(df %>% select_if(is.numeric)))
})
```
...
renderPlot({
  ...
  ggplot(df,aes(y = !!sym(input$`Variable 2`),
                x = !!sym(input$`Variable 1`)))+
    geom_boxplot()+
    coord_flip()+
    theme_minimal()+
    labs(x = input$`Variable 2`,y = input$`Variable 1`,
         title = paste("Boxplot of",input$`Variable 1`,"by",input$`Variable 2`))
})
```
...
renderUI({
  ...
  selectInput("Variable 5", label = "Select Color by Variable:", choices = colnames(df %>% select_if(is.character)))
})
```
...
renderPlot({
  ...
  ggplot(df,aes(x = !!sym(input$`Variable 3`),
                ...
                color = !!sym(input$`Variable 5`))) +
    geom_point() +
    theme_minimal() +
    theme(legend.position = "bottom") +
    labs(x = input$`Variable 3`,y = input$`Variable 4`,
         title = paste("Scatterplot of",input$`Variable 3`,"and",input$`Variable 4`),subtitle = paste("Color by",input$`Variable 5`))
  # plot_ly(df,
  #         x = ~df[[input$`Variable 1`]],
